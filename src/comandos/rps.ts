...
type Opcion = 'piedra' | 'papel' | 'tijeras';

const comando: Comando = {
  nombre: 'rps',
  descripcion: 'Juega piedra, papel o tijeras contra el bot',
  uso: '!rps <piedra|papel|tijeras>',
  ejecutar: (message, args) => {
    const opciones: Opcion[] = ['piedra', 'papel', 'tijeras'];
    const eleccionUsuario = args[0]?.toLowerCase() as Opcion;
